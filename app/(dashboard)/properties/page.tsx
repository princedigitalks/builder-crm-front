        ...
        {isModalOpen && (
          <>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-10 space-y-5 overflow-y-auto max-h-[70vh]">
                <div className="grid grid-cols-2 gap-5">
                   <div className="col-span-2 space-y-1.5">
                      ...
                      <input 
                        ...
                        className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold placeholder:text-slate-300 focus:outline-none focus:bg-white focus:border-indigo-400 focus:ring-4 focus:ring-indigo-50 transition-all"
                      />
                   </div>
                   ...
                   <div className="space-y-1.5">
                      ...
                      <select 
                        ...
                        className="w-full px-5 py-3.5 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold focus:outline-none focus:bg-white focus:border-indigo-400 transition-all appearance-none cursor-pointer"
                      >
                   ...
                   <div className="col-span-2 space-y-1.5">
                      ...
                      <p className="text-[9px] text-slate-400 ml-1">Optional: Paste a direct image link to preview</p>
                   </div>
                </div>
